...
2.	Jetzt installiert man unter folgendem Link die nötigen Libraries und Treiber, um den NIBOBee zum laufen zu kriegen
	...
	Gibt es jetzt immernoch Probleme, so führt man die NiboRoboLib 3.4.1 (64 bit) Setup.exe aus und stellt unter dem Punkt Modify sicher,
	das bei dem Unterpunkt NiboRoboLib / ARDUINO 1.6.6 integration kein rotes häckchen mehr vorhanden ist.
...
5.	Ist der NIBObee fertig zusammengelötet und funktioniert auch beim Einschalten, 
	...
	Unter dem Punkt: Datei / Beispiele / NIBObee / Kalibrierung kann muss man den NIBObee nun Kalibrieren.
	...
	Die annäherungssensoren sollten nach der Kalibrierung deutlich besser als vorher funktionieren.

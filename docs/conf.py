...
latex_documents = [
    (master_doc, 'NIBOBee.tex', u'NIBOBee Documentation',
     u'M. Meiners', 'manual'),
]
...
man_pages = [
    (master_doc, 'nibobee', u'NIBOBee Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'NIBOBee', u'NIBOBee Documentation',
     author, 'NIBOBee', 'One line description of project.',
     'Miscellaneous'),
]
